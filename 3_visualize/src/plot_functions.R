...
#function to create plot of data and save as .png file. Also saves the model diagnostics
...
make_diagnostics_file<-function(eval_data,outdir,fname){
  ...
  render_data <- list(pgdl_980mean = filter_function(eval_data,'pgdl', "similar_980",2),
                      ...
                      pb_980mean = filter_function(eval_data, 'pb', "similar_980",2),
                      dl_500mean = filter_function(eval_data, 'dl', "similar_500",2),
                      pb_500mean = filter_function(eval_data, 'pb', "similar_500",2),
                      dl_100mean = filter_function(eval_data, 'dl',"similar_100",2),
                      pb_100mean = filter_function(eval_data, 'pb', "similar_100",2) ,
                      pgdl_2mean = filter_function(eval_data, 'pgdl',"similar_2",2),
                      pb_2mean = filter_function(eval_data, 'pb', "similar_2",2) )
